        ...
        <div class="grid three">
          ...
          <%
            ...
            try {
              ...
              <img class="main-img" src="<%=request.getContextPath()%>/images/<%= rs.getString("PRO_IMG") %>">
